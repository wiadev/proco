...
// Actions
const STARTED = 'proco/auth/STARTED';
const STOPPED = 'proco/auth/STOPPED';
const LOADED = 'proco/auth/LOADED';
const LOGGED_IN = 'proco/auth/LOGGED_IN';
const LOGGED_OUT = 'proco/auth/LOGGED_OUT';
