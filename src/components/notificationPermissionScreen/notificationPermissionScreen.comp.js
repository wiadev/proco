...
class notificationPermissionScreenComp extends Component {
  static getStyles() {
    return styles;
  }
        ...
        >
          <View style={this.styles.permissionArea}>
            ...
            <Text style={this.styles.permissionText}>
              Do you want to receive a notification when a match happens?
            </Text>
...
export default notificationPermissionScreenComp;
