      ...
      <View style={styles.popup}>
        <BlurView blurType="light" style={styles.blurView}>
          <View style={styles.popupInside}>
            <Image resizeMode={'contain'} source={require('../../assets/images/grofersBeeVisuals.png')} style={styles.image} />
            <Text style={styles.headText}>We'll need to verify your school e-mail.</Text>
