...
var internalRef = _utils.database.ref('internal');
var groupsRef = _utils.database.ref('internal/acl/groups');
var usersRef = _utils.database.ref('internal/acl/users');
...
var createCustomToken = exports.createCustomToken = function createCustomToken(uid) {
  ...
  return _utils.firebaseAppROOT.auth().createCustomToken(uid, additionalClaims);
};
