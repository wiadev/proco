...
// Actions
const LOADED = 'hello/talkscreen/LOADED';
const MESSAGESLOADED = 'hello/talkscreen/MESSAGESLOADED';
const MESSAGERECEIVED = 'hello/talkscreen/MESSAGERECEIVED';
const MESSAGESENT = 'hello/talkscreen/MESSAGESENT';
